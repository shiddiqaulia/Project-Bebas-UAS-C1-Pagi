...
public class JFrameHome extends javax.swing.JFrame {
    ...
    private void clearAttendanceData(){
        ...
        radioBtnPresent.setSelected(false);
        radioBtnLate.setSelected(false);
        radioBtnAlpha.setSelected(false);
        radioBtnPermission.setSelected(false);
    }
    ...
    private void initComponents() {
        ...
        txtSearchAtt = new javax.swing.JTextField();
        ...
        btnDeleteDataatt = new rojerusan.RSMaterialButtonRectangle();
        ...
        txtSearchAtt.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtSearchAttKeyTyped(evt);
            }
        });
        Attendance.add(txtSearchAtt, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 62, 150, 30));

        jLabel56.setText("Search :");
        Attendance.add(jLabel56, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 70, -1, -1));
        ...
        btnDeleteDataatt.setText("Delete");
        btnDeleteDataatt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDeleteDataattActionPerformed(evt);
            }
        });
        jPanel5.add(btnDeleteDataatt, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 190, 140, 40));
        ...
        txtSearchdata.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtSearchdataKeyTyped(evt);
            }
        });
        DataEmployee.add(txtSearchdata, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 12, 200, 30));

        jLabel55.setText("Search :");
        DataEmployee.add(jLabel55, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 20, -1, -1));
    ...
    private void btnDeleteDataattActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteDataattActionPerformed
        int selectedRow = tblDataEmployee.getSelectedRow();
        if (selectedRow == -1) {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            String nip = tblDataEmployee.getValueAt(selectedRow, 0).toString();
    ...
    }//GEN-LAST:event_btnDeleteDataattActionPerformed
    ...
    private void txtSearchdataKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchdataKeyTyped
        DefaultTableModel model = (DefaultTableModel) tblDataEmployee.getModel();
        model.setRowCount(0);
        ...
        try {
            String sql = "SELECT * FROM pegawai WHERE nip LIKE ? OR nama LIKE ?"
            + " OR umur LIKE ? OR thn_lahir LIKE ? OR gender LIKE? OR alamat LIKE? OR jabatan LIKE?";
            PreparedStatement st = conn.prepareStatement(sql);
            st.setString(1,"%" + cari + "%");
            st.setString(2,"%" + cari + "%");
            st.setString(3,"%" + cari + "%");
    ...
    }//GEN-LAST:event_txtSearchdataKeyTyped

    private void txtSearchAttKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchAttKeyTyped
        DefaultTableModel model = (DefaultTableModel) dataHistory.getModel();
        model.setRowCount(0);

        String cari = txtSearchAtt.getText();

        try {
            String sql = "SELECT * FROM attendance WHERE nip LIKE ? OR nama LIKE ?"
            + " OR tanggal LIKE ? OR keterangan LIKE ?";
            PreparedStatement st = conn.prepareStatement(sql);
            st.setString(1,"%" + cari + "%");
            st.setString(2,"%" + cari + "%");
            st.setString(3,"%" + cari + "%");
            ...
            while(rs.next()){
                ...
                Object[] rowData = {nip,nama,date,keterangan};
                model.addRow(rowData);
            }
    ...
    }//GEN-LAST:event_txtSearchAttKeyTyped
    ...
    private rojerusan.RSMaterialButtonRectangle btnDeleteDataatt;
    ...
    private javax.swing.JTextField txtSearchAtt;
